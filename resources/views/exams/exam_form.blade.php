...
<form action="/schools/{{ $school->id }}/exams/{{ $exam->id }}" method="POST">
    ...
    <form action="/schools/{{ $school->id }}/exams" method="POST">
        ...
        <div class="row mb-3">
            ...
            <div class="col">
                <input type="text" class="form-control form-control-sm @error('title') is-invalid @enderror" required
                    name="title" id="title" maxlength="100" value="{{ old('title', $exam->title) }}">
                @if ($errors->has('title'))
        ...
        {{-- subject --}}
        <div class="row mb-3">
            <label for="subject_id" class="col-sm-2 col-form-label col-form-label-sm">@lang('exam.subject') :
                *</label>
        ...
        {{-- status --}}
        <div class="row mb-3">
            <label for="exam_status_id" class="col-sm-2 col-form-label col-form-label-sm">@lang('exam.exam_status') :
                *</label>

            <div class="col-sm-4">
                <x-select-exam-status name="exam_status_id" id="exam_status_id" required="true"
                    :placeholder="__('exam.select_a_status')" :value="old('exam_status_id', $exam->exam_status_id)" />
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <textarea class="form-control form-control-sm @error('description') is-invalid @enderror"
                    ...
                    maxlength="1000">{{ old('description', $exam->description) }}</textarea>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <textarea class="form-control form-control-sm @error('instruction') is-invalid @enderror"
                    ...
                    maxlength="1000">{{ old('instruction', $exam->instruction) }}</textarea>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-3">
                ...
                <div id="startDateHelp" class="form-text">@lang('exam.format_date')</div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-3">
                ...
                <div id="endDateHelp" class="form-text">@lang('exam.format_date')</div>
