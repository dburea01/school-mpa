        ...
        <form class="row" action="/exams">
            ...
            <div class="col-md-2 col-sm-12">
                <x-select-classroom name="filter_by_classroom_id" id="filter_by_classroom_id" required="false"
                    :value="$filter_by_classroom_id" :placeholder="__('exams.filter_by_classroom')" />
            </div>

            <div class="col-md-2 col-sm-12">
                <x-select-subject name="filter_by_subject_id" id="filter_by_subject_id" required="false"
                    :value="$filter_by_subject_id" :placeholder="__('exams.filter_by_subject')" />
            </div>

            <div class="col-md-2 col-sm-12">
                <x-select-exam-type name="filter_by_exam_type_id" id="filter_by_exam_type_id" required="false"
                    :value="$filter_by_exam_type_id" :placeholder="__('exams.filter_by_exam_type')" />
            </div>
            ...
            <tbody>
                ...
                <tr class="align-middle">
                    <td class="text-truncate">
                        <a href="/exams/{{ $exam->id }}/edit">{{ $exam->title }}</a>
                    </td>
                    ...
                    <td><a class="btn btn-sm btn-primary" href="/exams/{{ $exam->id }}/results">
